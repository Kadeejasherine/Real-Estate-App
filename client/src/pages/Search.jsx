...
<button className=' bg-s late-700 text-white
...
<h1 className='text-2xl font-semibold border-b p-3 text-slate-700 mt-5'>Search results</h1>

<div className='p-7 flex flex-wrap gap-4'>
{!loading && listings.length === 0 && (
    <p className='text-xl text-slate-700'>No spaces found!</p>
)}
{loading && (
